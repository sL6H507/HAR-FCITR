...
import threading,subprocess,sys,home,predict,torch,nvsmi,os,yaml,psutil
...
class Train(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.canvas.create_text(11.0, 501.0, anchor="nw", text="CPU/GPU Info", fill="#000000", font=("Inter", 32 * -1))
